...
class ALinks(unittest.TestCase):
    ...
    def test_a_links(self):
        link_title = {
            "Assessment Center (Placement Tests)" : "De Anza College :: Assessment Center :: Home",
            ...
            "Associate Degree for Transfer (AA-T and AS-T)" : "De Anza College :: Transfer Planning :: Home",
            "Astronomy Department": "De Anza College :: Astronomy :: Home",
            "Athletics": "De Anza College :: Athletics :: Welcome to Athletics",
            "Automotive Technology": "De Anza College :: Automotive Technology :: What We Offer",
